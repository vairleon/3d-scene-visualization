...
int main()
{
    ...
    // set sceneShader uniform variable
    // ----------------------------------
   
    // draw in wireframe
    //glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);

    // initialize model transformations (vec4
    glm::mat4 model_s = glm::mat4(1.0f);
    model_s = glm::translate(model_s, glm::vec3(-1.25f, -2.5f, -0.5f));
    vector<glm::vec3> cubePositions = {
        glm::vec3(-0.5f, -4.0f, 0.0f), //init pos
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        sceneShader.setMat4("model", model_s);
        ...
        model_c = glm::scale(model_c, glm::vec3(0.5f, 0.5f, 0.5f));	// it's a bit too big for our scene, so scale it down
        customAnimation(model_c, currentFrame, cubePositions);
        //model_c = glm::translate(model_c, cubeinitPositions);      
        cubeShader.setMat4("model", model_c);  
